...
/**
 * Data stored inside patched APKs as ~~"aliucord.json"~~ "rain.json" in order to preserve install-time information about Aliucord and the Manager.
 */
@Serializable
data class InstallMetadata(
    ...
    /**
     * Version of RainXposed embedded into the APK.
     */
    val rainXposedVersion: SemVer?,
)
