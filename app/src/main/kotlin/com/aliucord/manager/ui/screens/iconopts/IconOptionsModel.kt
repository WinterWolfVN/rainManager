...
class IconOptionsModel(
    ...
    init {
        when (prefilledOptions) {
            is IconReplacement.CustomColor if prefilledOptions.color == IconReplacement.RainColor -> {
                changeMode(IconOptionsMode.Rain)
                initSelectedColor(IconReplacement.RainColor)
            }
    ...
    fun generateConfig(): IconReplacement? {
        return when (mode) {
            ...
            IconOptionsMode.Rain -> IconReplacement.CustomColor(IconReplacement.RainColor)
